...
*/
export declare class Real_time {
    baseURL: string;
    port?: number;
    url: string;
     ...
     */
    createSubscription(subscriptionName: string, aaaaa: any | undefined): Promise<string>;
    /**
  ...
  */
    supportedSubscriptions(subscriptionObject: SubscriptionObject): Promise<SupportedSubscriptionsResponseOutputObject>;
    /**
